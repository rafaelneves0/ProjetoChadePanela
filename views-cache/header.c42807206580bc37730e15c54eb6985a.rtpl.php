...
<head>
  ...
  <title>Suel Administrator</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin" class="logo">
      ...
      <span class="logo-mini"><b>SR</b>A</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Suel</b> Admin</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/gift"><i class="fa fa-archive"></i> <span>Presentes</span></a></li>
        <li class="treeview">
